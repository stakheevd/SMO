...
void MainWindow::on_startAutoMode_clicked()
{
   ...
   start_simulation(Mode::Automatic);
...
void MainWindow::start_simulation(Mode mode)
{
	...
	Simulator* simulator = new Simulator(number_requests, number_producers, number_buffers, number_consumers, lambda);
    ...
    main_table->setRowCount(number_producers);
    us_table->setRowCount(number_producers);
